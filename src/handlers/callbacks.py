...
async def task_conf_callback(update: Update, context: ContextTypes.DEFAULT_TYPE, db) -> None:
...
async def handle_inline_query(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    results = [
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(f"Bizning ishlarimizni ko'ring: {config.WEBAPP_URL}")
        )
    ]
