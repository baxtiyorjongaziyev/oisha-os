    ...
    def get_current_weather():
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if w_code > 0:
                    if w_code < 3: condition = "Qisman bulutli"
                    elif w_code < 50: condition = "Tumanli"
                    elif w_code < 60: condition = "Yomg'ir shivalayapti"
                    elif w_code < 70: condition = "Yomg'ir"
                    elif w_code < 80: condition = "Qor yo'g'yapti"
                    else: condition = "Momaqaldiroq"
