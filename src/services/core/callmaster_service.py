"""Self-hosted outbound call campaign core for Oisha-OS.

This module is intentionally provider-agnostic. It stores campaigns, contacts,
call attempts, and webhook outcomes so a cheap Asterisk/GSM/SIP dialer can be
attached later without changing Oisha's business logic.
"""
