...
SALES_KP_STATUS_ID = 88871062  # KP
SALES_NEGOTIATION_STATUS_ID = 88871066  # Muzokara
SALES_ADVANCE_PENDING_STATUS_ID = 88871070  # Avans kutilmoqda
LEGACY_CLOSER_PIPELINE_ID = 11162702  # [ARXIV] 2. CLOSER — faqat yopilgan bitimlar
...
UTC_PIPELINE_ID = 11322658
UTC_NEW_STATUS_ID = 88756946  # Yangi murojaat
TARGET_LEADS_PIPELINE_ID = 11322658  # Default / UTC voronkasi
TARGET_LEADS_NEW_STATUS_ID = 88756946  # Yangi murojaat
TARGET_LEADS_CONTACTED_STATUS_ID = 88756950  # Aloqa qilindi
TARGET_LEADS_FIRST_CONTACT_STATUS_ID = 88756946  # Yangi murojaat (boshlang'ich voronka bosqichi)

# Inhouse Meta leadlari endi Sotuv -> Yangi ga tushadi; manba "Lead manbasi = Target" + "Target" tegi bilan ajraladi
TARGET_LEADS_INHOUSE_PIPELINE_ID = SALES_PIPELINE_ID
TARGET_LEADS_INHOUSE_NEW_STATUS_ID = SALES_NEW_STATUS_ID
LEGACY_TARGET_LEADS_PIPELINE_ID = 11295630  # [ARXIV] Target LEADs — faqat yopilgan bitimlar
TARGET_LEAD_TAG = "Target"
