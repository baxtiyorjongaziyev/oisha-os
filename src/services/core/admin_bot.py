...
class AdminBot:
    ...
    async def start(self):
        ...
        self.bot_client.add_event_handler(self.oisha_audit_handler, events.NewMessage(pattern=r"(?i)^/oisha_audit"))
        self.bot_client.add_event_handler(self.oisha_self_diagnosis_handler, events.NewMessage(pattern=r"(?i)^/oisha_rivoj$"))
        self.bot_client.add_event_handler(self.oisha_improvements_handler, events.NewMessage(pattern=r"(?i)^/oisha_takliflar$"))
        self.bot_client.add_event_handler(self.junk_audit_handler, events.NewMessage(pattern=r"(?i)^/junk_audit"))
        self.bot_client.add_event_handler(self.oisha_plan_handler, events.NewMessage(pattern=r"(?i)^/oisha_plan"))
        self.bot_client.add_event_handler(self.oisha_fact_handler, events.NewMessage(pattern=r"(?i)^/oisha_fact"))
        self.bot_client.add_event_handler(self.oisha_stats_handler, events.NewMessage(pattern=r"(?i)^/oisha_stats"))
        self.bot_client.add_event_handler(self.sales_priorities_handler, events.NewMessage(pattern=r"(?i)^/(sales_today|bugun_sotuv|kimga_qongiroq)"))
        self.bot_client.add_event_handler(self.project_risks_handler, events.NewMessage(pattern=r"(?i)^/(project_risks|loyiha_risk|deadline_risk)"))
        self.bot_client.add_event_handler(self.finance_risks_handler, events.NewMessage(pattern=r"(?i)^/(finance_risks|moliya_risk|pul_risk)"))
        self.bot_client.add_event_handler(self.team_capacity_handler, events.NewMessage(pattern=r"(?i)^/(team_capacity|jamoa_yuklama|bandlik)"))
        self.bot_client.add_event_handler(self.command_center_handler, events.NewMessage(pattern=r"(?i)^/(command_center|oisha_center|biznes_markaz)"))
        self.bot_client.add_event_handler(self.chatid_handler, events.NewMessage(pattern=r"(?i)^/chatid"))
        self.bot_client.add_event_handler(self.start_handler, events.NewMessage(pattern=r"(?i)^/start"))
        self.bot_client.add_event_handler(self.vps_handler, events.NewMessage(pattern=r"(?i)^/vps_status"))
        self.bot_client.add_event_handler(self.callback_handler, events.CallbackQuery())
        self.bot_client.add_event_handler(self.contact_card_handler, events.NewMessage())
        self.bot_client.add_event_handler(self.phone_handler, events.NewMessage())
        self.bot_client.add_event_handler(self.manual_search_command_handler, events.NewMessage(pattern=r"(?i)^/search(?:\s+(.+))?"))
        self.bot_client.add_event_handler(self.logs_handler, events.NewMessage(pattern=r"(?i)^/logs"))
        self.bot_client.add_event_handler(self.sync_stats_handler, events.NewMessage(pattern=r"(?i)^/sync_stats"))
        self.bot_client.add_event_handler(self.sync_contacts_tg_handler, events.NewMessage(pattern=r"(?i)^/sync_contacts_tg"))
        self.bot_client.add_event_handler(self.set_position_handler, events.NewMessage(pattern=r"(?i)^/set_position"))
        self.bot_client.add_event_handler(self.topic_info_handler, events.NewMessage(pattern=r"(?i)^/topic_info"))
        self.bot_client.add_event_handler(self.set_distribution_handler, events.NewMessage(pattern=r"(?i)^/set_distribution"))
        self.bot_client.add_event_handler(self.add_manager_handler, events.NewMessage(pattern=r"(?i)^/add_manager"))
        self.bot_client.add_event_handler(self.managers_list_handler, events.NewMessage(pattern=r"(?i)^/managers"))
        self.bot_client.add_event_handler(self.night_shift_handler, events.NewMessage(pattern=r"(?i)^/night_shift"))
        self.bot_client.add_event_handler(self.pause_auto_handler, events.NewMessage(pattern=r"(?i)^/pause_auto"))
        self.bot_client.add_event_handler(self.resume_auto_handler, events.NewMessage(pattern=r"(?i)^/resume_auto"))
        self.bot_client.add_event_handler(self.auto_status_handler, events.NewMessage(pattern=r"(?i)^/auto_status"))
        self.bot_client.add_event_handler(self.set_mode_handler, events.NewMessage(pattern=r"(?i)^/set_mode(\s+\S+)?"))
        self.bot_client.add_event_handler(self.juma_send_handler, events.NewMessage(pattern=r"(?i)^/juma_send"))
        self.bot_client.add_event_handler(self.inline_search_handler, events.InlineQuery())

    async def oisha_audit_handler(self, event):
    ...
    async def oisha_self_diagnosis_handler(self, event):
    ...
    async def oisha_improvements_handler(self, event):
    ...
    async def junk_audit_handler(self, event):
    ...
    async def oisha_plan_handler(self, event):
    ...
    async def oisha_fact_handler(self, event):
    ...
    async def oisha_stats_handler(self, event):
    ...
    async def sales_priorities_handler(self, event):
    ...
    async def project_risks_handler(self, event):
    ...
    async def finance_risks_handler(self, event):
    ...
    async def team_capacity_handler(self, event):
    ...
    async def command_center_handler(self, event):
    ...
    async def chatid_handler(self, event):
    ...
    async def vps_handler(self, event):
    ...
    async def contact_card_handler(self, event):
        import re
    ...
    async def phone_handler(self, event):
        sender_id = event.sender_id
    ...
    async def manual_search_command_handler(self, event):
        sender_id = event.sender_id
    ...
    async def sync_stats_handler(self, event):
        if not self.access_manager.is_admin(event.sender_id):
            return
    ...
    async def sync_contacts_tg_handler(self, event):
        sender_id = event.sender_id
        if not self.access_manager.is_admin(sender_id):
            return
    ...
    async def set_position_handler(self, event):
    ...
    async def topic_info_handler(self, event):
    ...
    async def set_distribution_handler(self, event):
    ...
    async def add_manager_handler(self, event):
    ...
    async def managers_list_handler(self, event):
    ...
    async def night_shift_handler(self, event):
    ...
    async def pause_auto_handler(self, event):
    ...
    async def resume_auto_handler(self, event):
    ...
    async def auto_status_handler(self, event):
    ...
    async def set_mode_handler(self, event):
    ...
    async def juma_send_handler(self, event):
    ...
    async def inline_search_handler(self, event):
        import re, uuid
