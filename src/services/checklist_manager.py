...
class ChecklistManager:
    ...
    async def deploy_checklist(self, project_name: str, client_id: int, service_type: str) -> str:
        """
        ...
        for task in tasks:
            ...
            assignee_tag = f"@{target_id}" if target_id else f"<i>(Xali belgilanmagan: {task['role']})</i>"
