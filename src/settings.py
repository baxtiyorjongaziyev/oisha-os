...
class AppSettings(BaseSettings):
    ...
    GROQ_TEXT_MODEL: str = "groq/compound"
    ...
    PROJECTS_GROUP_ID: Optional[int] = -1003114662117
    PROJECTS_TOPIC_ID: Optional[int] = 1
    TEAM_GROUP_ID: Optional[int] = None
    TASKS_GROUP_ID: Optional[int] = None
    STAGNATION_GROUP_ID: Optional[int] = None
    WOW_SERVICE_GROUP_ID: Optional[int] = -1003114662117
    WOW_SERVICE_TOPIC_ID: Optional[int] = 1
    ...
    def normalize_empty_env_values(cls, data):
        return _normalize_env_dict(data)
