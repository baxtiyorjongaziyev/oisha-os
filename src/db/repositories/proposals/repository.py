...
from src.db.repositories.proposals.schema import (
    init_proposal_tables,
    rename_away_incompatible_legacy_table,
)
...
class ProposalRepository(BaseRepository):
    ...
    async def _rename_away_incompatible_legacy_table(self, conn) -> None:
        await rename_away_incompatible_legacy_table(self, conn)

    async def init_table(self) -> None:
        await init_proposal_tables(self)
