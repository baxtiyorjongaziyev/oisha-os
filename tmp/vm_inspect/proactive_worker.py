...
async def send_evening_fact_report():
    ...
    if is_quiet_hours(now):
        logger.info("[EVENING FACT] Quiet hours active. Skipping automatic plan-fact report.")
        return
    ...
    try:
        ...
        if not report_msg or "Bugun uchun rejalashtirilgan vazifalar topilmadi" in report_msg:
            logger.info("[EVENING FACT] No daily plan found. Telegram report skipped.")
