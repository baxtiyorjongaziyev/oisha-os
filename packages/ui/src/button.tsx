  ...
  const buttonElement = (
    <button
      ...
      className={[
        ...
        showTooltip
          ? "pointer-events-none group-focus-visible:ring-2 group-focus-visible:ring-amberline group-focus-visible:ring-offset-2"
          : "",
        variants[variant],
        className
      ].join(" ")}
  ...
  if (showTooltip) {
    return (
      <span
        ...
        tabIndex={0}
        className="group inline-block cursor-not-allowed focus:outline-none"
      >
        {buttonElement}
      </span>
    );
