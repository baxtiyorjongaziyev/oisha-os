...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Oracle VM & Telethon Live Status Box */}
      {sidebarOpen && (
        <div className="m-3 rounded-2xl bg-[var(--bg-surface-subtle)] p-3 border border-[var(--border-subtle)]">
          ...
          <div className="mt-2.5">
            <div className="flex justify-between text-[10px] text-[var(--text-secondary)]">
              <span>AmoCRM & Turso:</span>
              <strong className="text-[var(--text-primary)]">Ulangan</strong>
            </div>
            <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-[var(--bg-surface-active)]">
              <div className="h-full bg-[var(--accent-primary)]" style={{ width: "100%" }}></div>
            </div>
          </div>
        </div>
      )}
