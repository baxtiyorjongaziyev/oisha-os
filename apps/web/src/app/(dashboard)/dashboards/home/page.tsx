...
export default function HomePage() {
  ...
  const data = {
    today: {
      ...
      tasks: 0,
      pulseText:
        "Bugun faoliyat to'xtagan ko'rinadi. Obunangiz muzlatilganligi sababli yangi qo'ng'iroqlar tahlilga kirishi kechikmoqda yoki menejer faolligi aniqlanmadi.",
    ...
    week: {
      ...
      tasks: 12,
      pulseText:
        "Haftalik natijalar o'rtacha. Salomlashish va ehtiyoj aniqlash yaxshi, biroq 'Yopish va kelishuvlar' bosqichida zaifliklar mavjud.",
    ...
    month: {
      ...
      tasks: 84,
      pulseText:
        "Oylik umumiy ko'rsatkichlar ijobiy. 257 ta qo'ng'iroq tahlil qilindi. Top menejeringiz samaradorligi 75% KPI darajasiga yaqinlashmoqda.",
      pulseStatus: "Faol",
        ...
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="text-sm font-bold text-rose-800 dark:text-rose-400">
              Obuna holati: Muzlatilgan
            </h4>
            <p className="text-xs text-rose-700/80 dark:text-rose-400/70 mt-0.5">
              To&apos;lov amalga oshirilmaganligi sababli qo&apos;ng&apos;iroqlar tahlili
              vaqtinchalik to&apos;xtatilgan. Oylik narx: 640,000 UZS.
            </p>
          </div>
        </div>
        <Link
            ...
            switch (widget.id) {
              case "pulse":
                return (
                  <div
                    key={widget.id}
                    className="rounded-3xl border border-border bg-bg-card p-6 shadow-sm"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span
                          className={`h-2.5 w-2.5 rounded-full ${activeData.pulseColor} animate-pulse`}
                        ></span>
                    ...
                    <div className="flex flex-wrap gap-2 mt-4 border-b border-border pb-4">
                      <button
                        ...
                        className={`rounded-xl px-4 py-2 text-xs font-semibold transition-all ${
                          pulseFocus === "sales"
                            ? "bg-brand text-white"
                            : "bg-bg text-text hover:bg-brand-light"
                        }`}
                      >
                    ...
                    <div className="mt-4">
                      {pulseFocus === "sales" && (
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-text">
                            Sotuv faoliyati bo&apos;yicha tavsiya:
                          </h4>
                      ...
                      {pulseFocus === "tasks" && (
                        <div className="space-y-1">
                          <h4 className="text-xs font-bold text-text">
                            Topshiriqlar bajarilish holati:
                          </h4>
                          <p className="text-[11px] text-text-muted">
                            {timeFilter === "today"
              ...
              case "quality":
                return (
                  ...
                  >
                    ...
                    <div className="mt-6">
                      <div className="text-xs font-bold text-text mb-3 px-1">
                        Suhbat sifati tendentsiyasi (%)
                      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-text-muted mt-0.5">
                      Savdo mezonlari va qoidalarining jami 16 ta ko&apos;rsatkichi.
                    </p>
                      ...
                      {[
                        {
                          ...
                          items: [
                            {
                              code: "A1",
                              name: "Kompaniya va menejer tanishtirish",
                              val: timeFilter === "today" ? 0 : 85,
                              weak: 0
                            },
                            {
                              code: "A2",
                              name: "Murojaat manbasini aniqlash",
                              val: timeFilter === "today" ? 0 : 16,
                              weak: 4
                            },
                            {
                              code: "A3",
                              name: "Suhbat maqsadini belgilash",
                              val: timeFilter === "today" ? 0 : 23,
                              weak: 3
                            }
                          ]
                        },
                        {
                          category: "Ehtiyoj aniqlash",
                          items: [
                            {
                              code: "B1",
                              name: "Mijoz vaziyati ochilishi",
                              val: timeFilter === "today" ? 0 : 64,
                              weak: 1
                            },
                            {
                              code: "B2",
                              name: "Xizmat yo'nalishi aniqlanishi",
                              val: timeFilter === "today" ? 0 : 75,
                              weak: 0
                            },
                            {
                              code: "B3",
                              name: "Qaror va resurs holati",
                              val: timeFilter === "today" ? 0 : 38,
                              weak: 2
                            }
                          ]
                        }
                              ...
                              <div key={item.code} className="space-y-1">
                                <div className="flex items-center justify-between text-xs">
                                  <span className="font-semibold text-text truncate max-w-[80%]">
                                    <span className="inline-block bg-brand-light text-brand px-1.5 py-0.5 rounded font-mono font-bold mr-1.5">
                                      {item.code}
                                    </span>
                                    {item.name}
                                  </span>
                  ...
                  >
                    ...
                    <div className="mt-4 space-y-3">
                      {[
                        {
                          type: "error",
                          title: "Menejer faolligi yo'q",
                          text: "Baxtiyorjon Gaziyev bugun birorta ham qo'ng'iroqni amalga oshirmadi.",
                          time: "17 soat oldin"
                        },
                        {
                          type: "warning",
                          title: "Suhbat sifati past",
                          text: "Oxirgi 5 ta qo'ng'iroq bo'yicha o'rtacha sifat 24% (KPI: 75%+).",
                          time: "1 kun oldin"
                        }
                      ].map((al, idx) => (
                        <div
                          key={idx}
                          className="flex gap-3 rounded-2xl bg-bg p-3 border border-border"
                        >
                          <div
              ...
              case "latest_calls":
                return (
                  <div
                    key={widget.id}
                    className="rounded-3xl border border-border bg-bg-card p-6 shadow-sm overflow-hidden"
                  >
                    <h3 className="text-base font-bold text-text">So&apos;nggi tahlillar</h3>

                    {timeFilter === "today" || activeData.calls.length === 0 ? (
                      <div className="py-8 text-center text-xs text-text-muted">
                        Bu davr uchun scored (baholangan) qo&apos;ng&apos;iroqlar ro&yxati
                        yo&apos;q.
                      </div>
                    ) : (
              ...
              default:
                ...
                return (
                  <div
                    key={widget.id}
                    className="rounded-3xl border border-border border-dashed bg-bg-card p-6 shadow-sm flex flex-col items-center justify-center text-center"
                  >
                    <h4 className="text-xs font-bold text-text-muted">{widget.name}</h4>
                    <p className="text-[10px] text-text-muted mt-1 max-w-sm">
                      Ushbu qo&apos;shimcha tahliliy blok Next-bosqichda real ma&apos;lumotlar
                      oqimiga bog&apos;lanadi. Hozircha sozlamalar bo&apos;limi orqali interfeys
                      ko&apos;rinishini sinashingiz mumkin.
                    </p>
                  </div>
                );
            }
          ...
          <div className="w-full max-w-md h-full bg-bg-popover border-l border-border p-6 shadow-2xl overflow-y-auto animate-fade-in flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-border pb-4">
                <h3 className="text-base font-bold text-text">
                  Dashboard bo&apos;limlarini sozlash
                </h3>
                <button
              ...
              <p className="text-xs text-text-muted mt-2">
                Asosiy sahifadagi bloklarni yoqish/o&apos;chirish yoki ularning joylashuv tartibini
                o&apos;zgartirish.
              </p>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="rounded p-1 text-text-muted hover:bg-brand-light hover:text-brand disabled:opacity-30 disabled:pointer-events-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-1 active:scale-[0.98] transition-all"
                      >
                        <svg
                          aria-hidden="true"
                          className="h-4 w-4"
